  ...
  return (
    <>
      <main className='w-[100%] h-[100vh] py-8 px-4 grid place-items-center bg-[#fafbff]'>
        <div className="w-full max-w-[1000px] p-4 rounded-lg grid grid-cols-[320px_1fr] shadow-[10px_10px_80px_-10px_#0000001a] overflow-hidden bg-white">
                  <div className={`py-12 px-8 rounded ${isMobile?'bg-[url("/assets/images/bg-sidebar-mobile.svg")]':'bg-[url("/assets/images/bg-sidebar-desktop.svg")]'} bg-no-repeat bg-center bg-cover flex flex-col gap-8 overflow-auto`}>
          ...
          <div className="pt-16 px-8 pb-8 max-w-[600px] w-full justify-self-center flex flex-col overflow-hidden gap-8">
...
// border-2 bg-[#bfe2fd] text-[#02295a] border-[#bfe2fd] active style